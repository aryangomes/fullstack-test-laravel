...
use App\Http\Controllers\RespostaRequisicaoController;
...
Route::get(
    ...
    fn () => response()->json(
        [
            'dataHoraAtual' => now()->toIso8601String()
        ]
    )
)
    ->name('exibirDataHoraAtual');

// TODO: criar uma rota POST que chame uma função em um controller e retorne o texto recebido na requisição
Route::post(
    '/retornaTexto',
    [RespostaRequisicaoController::class, 'retornaTexto']
)->name('retornaTexto');
